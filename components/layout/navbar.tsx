...
export default function Navbar() {
  ...
  const logoSrc = isDark ? "/logos/logo-light.png" : "/logos/logo-dark.png";
  ...
  return (
    <>
      ...
      >
        <nav className="w-full flex items-center justify-between px-6 md:px-10 lg:px-16 py-4">
          {/* Logo + Desktop Navigation */}
          <div className="flex items-center gap-10">
            <Link
              href="/"
              aria-label="صفحه اصلی تیم نما"
            ...
            >
              <img
                ...
                width={120}
                height={40}
                className="w-28 h-auto transition-all object-contain"
              />
            </Link>
